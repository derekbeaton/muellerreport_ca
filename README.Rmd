...
words_counts_lims <- max(max(abs(words_counts_ca_comps12_fi_df)),max(abs(words_counts_ca_comps12_fj_df)))
...
ggplot(words_counts_ca_comps12_fi_df, aes(COMP1, COMP2, label=rownames(words_counts_ca_comps12_fi_df))) +
...
ggplot(words_counts_ca_comps12_fj_df, aes(COMP1, COMP2, label=rownames(words_counts_ca_comps12_fj_df))) +
  geom_hline(yintercept = 0, color = "black") +
  geom_vline(xintercept = 0, color="black") +
  geom_point() +
  # geom_text_repel(box.padding = .01, point.padding = .01) +
